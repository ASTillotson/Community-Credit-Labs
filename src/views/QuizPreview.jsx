...
class QuizPreview extends Component {
    ...
    render() {
        ...
        if (page.contents.content && !this.state.setQuiz) {
        ...
        if (this.state.quiz) {
            ...
            question = quiz.theQuestion;
            answerOne = quiz.answerOne;
            answerTwo = quiz.answerTwo;
            answerThree = quiz.answerThree;
            answerFour = quiz.answerFour;
            checkOne = quiz.checkOne;
            checkTwo = quiz.checkTwo;
            checkThree = quiz.checkThree;
            checkFour = quiz.checkFour;
        };
